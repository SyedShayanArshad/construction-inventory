...
import { products, getVendorById } from '../../lib/demo-data';
...
export default function Inventory() {
  ...
  const [editPurchse, setEditPurchase] = useState(null);
  ...
  return (
    <div className="space-y-6">
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="whitespace-nowrap text-right text-sm font-medium px-3 py-4">
                      <button
                        onClick={() => {setEditPurchase(product)
      ...
      {showEditPurchaseModal && (
        <AddNewPurchaseModel onClose={()=>setEditPurchaseModal(false)} product={editPurchse}/>
      )}
