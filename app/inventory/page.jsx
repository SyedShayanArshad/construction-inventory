            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {filteredPurchases.map((purchase) =>
                purchase.purchaseItems.map((item) => {
                  ...
                  const vendor = purchase.vendor; // Vendor is at purchase level
                  const isLowStock =
                    product.quantity <= product.lowStockThreshold;

                  return (
                    <tr
                      key={`${purchase.id}-${item.id}`} // Unique key using purchase and item IDs
                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">
                        ...
                        {/* Use sellRate for unit price */}
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        {formatCurrency(item.rate)} {/* Use rate for cost */}
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">
                        {formatCurrency(calculateTotalValue(product, item))}
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
