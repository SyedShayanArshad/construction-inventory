...
export default function MobileNavigation() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-2 z-20">
      <div className="flex justify-around">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <div className={`p-1.5 rounded-full mb-1 ${isActive ? 'bg-blue-100' : ''}`}>
                <svg
              ...
              {isActive && <div className="h-1 w-1 rounded-full bg-blue-600 mt-1"></div>}
            </Link>
          );
        })}
      </div>
